            ...
            <div class="content controls npt">
                <div class=form-row>
                    ...
                    <div class=col-md-6>
                        <div class=input-group>
                            ...
                            <input type=text class=form-control placeholder="Second Name" /> </div>
                    </div>
                </div>
                <div class=form-row>
                    <div class=col-md-6>
                        <div class=input-group>
                            ...
                            <input type=text class=form-control placeholder="Country" /> </div>
                    </div>
                    <div class=col-md-6>
                        <div class=input-group>
                            <div class=input-group-addon>
                ...
                <div class=form-row>
                    <div class=col-md-12>
                        <div class=checkbox>
                            <label>
                                <input type="checkbox" /> Agree with terms and conditions</label>
                        </div>
                    </div>
                </div>
                <div class=form-row>
                    <div class=col-md-12> <a href=# class="btn btn-default btn-block btn-clean">Sign In</a> </div>
                </div>
                <div class=form-row>
                ...
                <div class=form-row>
                    ...
                    <div class=col-md-6>
                        <a href=# class="btn btn-primary btn-block">
                            <span class=icon-twitter></span> &nbsp; Tweeter</a>
                    </div>
                </div>
            </div>
        </div>
